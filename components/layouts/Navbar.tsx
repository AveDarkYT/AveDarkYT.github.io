...
const PROFILE_MENU_LINKS = [
  ...
  },
  {
    ...
    label: "Preferencias de Correo",
    Icon: Settings,
  },
  { path: PROFILE_MENU_PATHS[2], label: "Documentación API", Icon: FileCode },
  { path: PROFILE_MENU_PATHS[3], label: "Estado de API", Icon: Activity },
] as const;
